...
import {SparklesIcon, ArrowRightIcon, ZapIcon, CheckIcon, VideoIcon, Code2Icon, UserIcon} from "lucide-react";
        ...
        <Link to={"/"}  
         className="flex items-center gap-3 hover:scale-105 transition-transform duration-200">
          ...
          <div className="flex flex-col">
            <span className="font-black text-xl bg-gradient-to-r from-primary via-secondary to-accent
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body items-center text-center">
              ...
              <p className="text-base-content/70">
                Crystall clear video and audio for seamless communication during interviews
              </p>
            </div>
          </div>
